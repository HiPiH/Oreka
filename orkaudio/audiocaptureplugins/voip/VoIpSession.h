...
#define PROT_UNKN "Unkn"
	...
	void ReportRtcpSrcDescriptionInTags(std::map<int,CStdString>& tags);
...
private:
	...
	std::list<CStdString> m_callsIds;
...
public:
	...
	void ReportRtcpSrcDescriptionInTags(RtcpSrcDescriptionPacketInfoRef& rtcpInfo,std::map<int,CStdString>& tags);
